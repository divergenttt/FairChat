 ...
 */
export const getValidateInviteCodeUrl = () => {
  return `/api/auth/validate-invite`;
};

export const validateInviteCode = async (
  validateInviteRequest: ValidateInviteRequest,
  options?: RequestInit,
): Promise<ValidateInviteResponse> => {
  return customFetch<ValidateInviteResponse>(getValidateInviteCodeUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(validateInviteRequest),
  });
};

export const getValidateInviteCodeMutationOptions = <
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<ValidateInviteRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["validateInviteCode"];
  ...
  > = (props) => {
    ...
    return validateInviteCode(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type ValidateInviteCodeMutationResult = NonNullable<
  Awaited<ReturnType<typeof validateInviteCode>>
>;
export type ValidateInviteCodeMutationBody = BodyType<ValidateInviteRequest>;
export type ValidateInviteCodeMutationError = ErrorType<ErrorResponse>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getValidateInviteCodeMutationOptions(options));
};
...
export const checkUsername = async (
  ...
  return customFetch<CheckUsernameResponse>(getCheckUsernameUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(checkUsernameRequest),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<CheckUsernameRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type CheckUsernameMutationResult = NonNullable<
  Awaited<ReturnType<typeof checkUsername>>
>;
export type CheckUsernameMutationBody = BodyType<CheckUsernameRequest>;
...
export const getGetMessagesUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/api/messages/${recipientId}?${stringifiedParams}`
...
export const getMessages = async (
  ...
  return customFetch<Message[]>(getGetMessagesUrl(recipientId, params), {
    ...options,
    method: "GET",
  });
};
...
export const getGetMessagesQueryKey = (
  ...
  return [`/api/messages/${recipientId}`, ...(params ? [params] : [])] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetMessagesQueryKey(recipientId, params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getMessages>>> = ({
    signal,
  }) => getMessages(recipientId, params, { signal, ...requestOptions });
...
>(
  ...
  const queryOptions = getGetMessagesQueryOptions(recipientId, params, options);
 ...
 */
export const getSendMessageUrl = (recipientId: number) => {
  return `/api/messages/${recipientId}`;
};
...
export const sendMessage = async (
  ...
  return customFetch<Message>(getSendMessageUrl(recipientId), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { recipientId: number; data: BodyType<SendMessageRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return sendMessage(recipientId, data, requestOptions);
  };
...
/**
 * @summary Generate an invite code for the current user
 */
export const getGenerateInviteCodeUrl = () => {
  return `/api/invite/generate`;
};

export const generateInviteCode = async (
  options?: RequestInit,
): Promise<InviteCode> => {
  return customFetch<InviteCode>(getGenerateInviteCodeUrl(), {
    ...options,
    method: "POST",
  });
};
...
> => {
  ...
  const mutationFn: MutationFunction<
    ...
    void
  > = () => {
    return generateInviteCode(requestOptions);
  };
 ...
 */
export const getListMyInviteCodesUrl = () => {
  return `/api/invite/list`;
};

export const listMyInviteCodes = async (
  options?: RequestInit,
): Promise<InviteCode[]> => {
  return customFetch<InviteCode[]>(getListMyInviteCodesUrl(), {
    ...options,
    method: "GET",
  });
};

export const getListMyInviteCodesQueryKey = () => {
  return [`/api/invite/list`] as const;
};

export const getListMyInviteCodesQueryOptions = <
  TData = Awaited<ReturnType<typeof listMyInviteCodes>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof listMyInviteCodes>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getListMyInviteCodesQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listMyInviteCodes>>
  > = ({ signal }) => listMyInviteCodes({ signal, ...requestOptions });
...
export type ListMyInviteCodesQueryResult = NonNullable<
  Awaited<ReturnType<typeof listMyInviteCodes>>
>;
export type ListMyInviteCodesQueryError = ErrorType<unknown>;

/**
 * @summary List invite codes created by current user
 */

export function useListMyInviteCodes<
  TData = Awaited<ReturnType<typeof listMyInviteCodes>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getListMyInviteCodesQueryOptions(options);
